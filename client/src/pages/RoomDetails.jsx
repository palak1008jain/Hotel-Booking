  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            <h1 className='text-3xl mf:text-4xl font-playfair'>{room.hotel.name} <span className='font-inter text-sm'>({room.roomType})</span></h1>
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10 '>
                <div className='flex flex-col'>
                    <h1 className='text-3xl md:text-4xl font-playyfair'>Experience Luxury Like Never Before</h1>
            ...
            {roomCommonData.map((spec,index)=>(
                <div key={index} className='flex items-start gap-2'>
                    ...
                    <div>
                        ...
                        <p className='tex-gray-500'>{spec.description}</p>
                    </div>
                </div>
            ))}
        </div>
